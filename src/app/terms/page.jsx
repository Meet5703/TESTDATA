...
const page = () => {
  return (
    <>
      <NavbarByMe />
      <div className="px-20">
        <h4 className="text-4xl font-[800] text-center">
          Terms and Conditions
        </h4>
        <br />
        <div className="space-y-4 mt-4 ">
          <p className="text-justify text-lg">
            We employ the use of cookies. By accessing www.dataskillshub.com,
            you agreed to use cookies in agreement with the Data Skills Hub's
            Privacy Policy.
          </p>
          <p className="text-justify text-lg">
            These terms and conditions outline the rules and regulations for the
            use of Data Skills Hub's Website, located at
            https://dataskillshub.com.
          </p>
          <p className="text-justify text-lg">
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use www.dataskillshub.com if you do
        ...
        <div className="mt-4">
          <h5 className="text-3xl font-[800]">License</h5>
          <div className="space-y-4 mt-4 ">
            <p className="text-justify text-lg">
              Unless otherwise stated, Data Skills Hub and/or its licensors own
              the intellectual property rights for all material on
              www.dataskillshub.com. All intellectual property rights are
              reserved. You may access this from www.dataskillshub.com for your
            ...
            <p className="text-justify text-lg">
              ...
              <ul className="list-disc ml-12">
                <li>Republish material from www.dataskillshub.com</li>
                <li>
                  Sell, rent or sub-license material from www.dataskillshub.com
                </li>
                <li>
                  Reproduce, duplicate or copy material from
                  www.dataskillshub.com
                </li>
                <li>Redistribute content from www.dataskillshub.com</li>
              </ul>
            </p>
            <p className="text-justify text-lg">
            ...
            <p className="text-justify text-lg">
              ...
              Data Skills Hub does not filter, edit, publish or review Comments
              prior to their presence on the website. Comments do not reflect
              the views and opinions of Data Skills Hub,its agents and/or
              ...
              applicable laws, Data Skills Hub shall not be liable for the
            ...
            <p className="text-justify text-lg">
              {" "}
              Data Skills Hub reserves the right to monitor all Comments and to
        ...
        <div className="mt-4">
          <h5 className="text-3xl font-[800]">Cookies</h5>
          <div className="space-y-4 mt-4 ">
            <p className="text-justify text-lg">
              We employ the use of cookies. By accessing www.dataskillshub.com,
              you agreed to use cookies in agreement with the Data Skills Hub's
        ...
        <div className="mt-4">
          <h5 className="text-3xl font-[800]">Hyperlinking to our Content</h5>
          <div className="space-y-4 mt-4 ">
            <p className="text-justify text-lg">
            ...
            <p className="text-justify text-lg">
              ...
              Data Skills Hub; and (d) the link is in the context of general
            ...
            <p className="text-justify text-lg">
              ...
              by sending an e-mail to Data Skills Hub. Please include your name,
            ...
            <p className="text-justify text-lg">
              No use of Data Skills Hub's logo or other artwork will be allowed
              for linking absent a trademark license agreement.
            </p>
          </div>
        </div>
        <div className="space-y-6 mt-8">
          <p className="text-4xl font-[800]">iFrames</p>
          <p className="text-lg">
        ...
        <div className="space-y-6 mt-8">
          <p className="text-4xl font-[800]">Content Liability</p>
          <p className="text-lg">
        ...
        <div className="space-y-6 mt-8">
          <p className="text-4xl font-[800]">Reservation of Rights</p>
          <p className="text-lg">
        ...
        <div className="space-y-6 mt-8">
          <p className="text-4xl font-[800]">Refund Policy</p>
          <p className="text-lg">
            Our refund policy strictly states that we do not offer refunds for
            any course enrollments made on dataskillshub.com. Once a purchase is
            completed, it is considered final, and no refunds will be provided
            under any circumstances.
          </p>
        </div>
        <div className="space-y-6 mt-8">
          <p className="text-4xl font-[800]">Disclaimer</p>
          <p className="text-lg">
