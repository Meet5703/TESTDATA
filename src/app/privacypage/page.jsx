...
const page = () => {
  return (
    <>
      <NavbarByMe />
      <div className="ml-6 mr-6 px-16">
        <h5 className="text-2xl font-[800] text-center">
          Privacy Policy for Data Skills Hub
        </h5>
        <hr className="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700" />
        <div>
          <h5 className="text-5xl font-[800]">Privacy Policy</h5>
          <div className="space-y-6 mt-8">
            <p className="text-lg">Last updated: April 12, 2024</p>
            <p className="text-lg">
          ...
          <div>
            <h5 className="text-4xl font-[800] mt-8">
              Interpretation and Definitions
            </h5>
            <div className="space-y-6 mt-8">
              <h5 className="text-3xl font-[800]">Interpretation</h5>
              <p className="text-lg">
              ...
              <h5 className="text-3xl font-[800]">Definitions</h5>
              <p className="text-lg">
                For the purposes of this Privacy Policy:
                <ul className="mt-6 space-y-4">
                  <li>
                    - <span className="font-[800]">Account</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">Affiliate</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">Company</span>
                    <p className="ml-8">
                      (referred to as either "the Company", "We", "Us" or "Our"
                      in this Agreement) refers to Data Skills Hub, Upskilling
                      course and Placement service.
                    </p>
                  </li>
                  <li>
                    - <span className="font-[800]">Cookies</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">Country</span>
                    <p className="ml-8">refers to: Gujarat, India</p>
                  </li>
                  <li>
                    - <span className="font-[800]">Device</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">Personal Data</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">Service</span>
                    <p className="ml-8">refers to the Website.</p>
                  </li>
                  <li>
                    - <span className="font-[800]">Service Provider</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">Usage Data</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">Website</span>
                    <p className="ml-8">
                      refers to Data Skills Hub, accessible from
                      https://www.dataskillshub.com
                    </p>
                  </li>
                  <li>
          ...
          <div>
            ...
            <div className="space-y-6 mt-8">
              <h5 className="text-3xl font-[800]">Types of Data Collected</h5>
              <p className="text-2xl font-[800]">Personal Data</p>
              <ul>
            ...
            <div className="mt-6">
              <p className="text-2xl  font-[800]">Usage Data</p>
            ...
            <div className="mt-6">
              ...
              <ul className="mt-8">
                ...
                <li className="mt-4">
                  <span className="font-[800] text-xl">Web Beacons.</span>
                  <p className="mt-4">
                    ...
                    website statistics (for 4/9 example, recording the
                ...
                <li className="mt-4">
                  ...
                  <ul className="mt-4">
                    <li className="font-[800] text-lg">
                      {" "}
                      - Necessary / Essential Cookies
                    </li>
                    <li className="ml-9 text-justify">
          ...
          <div>
            <h5 className="text-2xl font-[800] mt-8">
            ...
            <div className="space-y-6 mt-8">
              <p className="text-lg">
                ...
                <ul className="mt-6 space-y-4">
                  ...
                  <li>
                    -{" "}
                    <span className="font-[800]">To manage Your Account:</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">To contact You:</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">To provide You</span>
                    <p className="ml-8">
                  ...
                  <li>
                    -{" "}
                    <span className="font-[800]">To manage Your requests:</span>
                    <p className="ml-8">
                  ...
                  <li>
                    -{" "}
                    <span className="font-[800]">For business transfers:</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">For other purposes:</span>
                    <p className="ml-8">
              ...
              <p className="text-lg">
                ...
                <ul className="mt-6 space-y-4">
                  <li>
                    -{" "}
                    <span className="font-[800]">With Service Providers:</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">With Affiliates:</span>
                    <p className="ml-8">
                  ...
                  <li>
                    -{" "}
                    <span className="font-[800]">With business partners:</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">With other users:</span>
                    <p className="ml-8">
                  ...
                  <li>
                    - <span className="font-[800]">With Your consent:</span>
                    <p className="ml-8">
          ...
          <div className="space-y-6 mt-8">
            <p className="text-2xl font-[800]">Delete Your Personal Data</p>
            <p className="text-lg">
          ...
          <div className="space-y-6 mt-8">
            ...
            <h5 className="text-xl font-[800]">Business Transactions</h5>
            <p className="text-lg">
            ...
            <h5 className="text-xl font-[800]">Law enforcement</h5>
            <p className="text-lg">
            ...
            <h5 className="text-xl font-[800]">Other legal requirements</h5>
            <p className="text-lg">
        ...
        <div className="space-y-6 mt-8">
          <p className="text-4xl font-[800]">Children's Privacy</p>
          <p className="text-lg">
        ...
        <div className="space-y-6 mt-8">
          <p className="text-4xl font-[800]">Links to Other Websites</p>
          <p className="text-lg">
        ...
        <div className="space-y-6 mt-8">
          <p className="text-4xl font-[800]">Changes to this Privacy Policy</p>
          <p className="text-lg">
        ...
        <div className="space-y-6 mt-8">
          <p className="text-4xl font-[800]">Contact Us</p>
          <p className="text-lg">
            If you have any questions about this Privacy Policy, You can contact
            us:
            <ul className="ml-10">
              - <li>By email: support@dataskillshub.com</li>-{" "}
              <li>
                By visiting this page on our website:{" "}
                <a
                  className="underline text-blue-500"
                  href=" https://www.dataskillshub.com/contact"
                >
                  https://www.dataskillshub.com/contact
                </a>
              </li>
              - <li>By phone number: 79904 33809</li>
            </ul>
          </p>
        </div>
      </div>
