...
import img2 from "../../assets/photo-1427751840561-9852520f8ce8.avif";
      ...
      <div className="max-w-screen-xl mx-auto mt-40">
        <main className="mt-12">
          <div className="grid grid-cols-9 gap-6 ">
            <div className="col-span-5 bg-white px-6 py-6 rounded-md">
              {/* <!-- main post --> */}
              <div className=" bg-white">
                ...
                />
                <span className="text-green-700 bg-transparent text-sm hidden md:block mt-4">
                  {" "}
                  Technology{" "}
                </span>
                <h1 className="text-gray-800 text-4xl font-bold bg-transparent mt-2 mb-2 leading-tight">
            ...
            {/* <!-- sub-main posts --> */}
            <div className="col-span-4 ml-4 bg-white p-6">
              <div className="bg-white">
                {/* <!-- post 1 --> */}
                <div className="rounded w-full flex flex-col md:flex-row mb-10 ">
                  ...
                  <div className="bg-white rounded px-4">
                    <span className="bg-transparent text-green-700 text-sm hidden md:block">
                      {" "}
                      Gadgets{" "}
                    </span>
                    <div className="md:mt-0 text-gray-800 bg-transparent font-semibold text-xl mb-2">
                ...
                {/* <!-- post 2 --> */}
                <div className="rounded w-full flex flex-col md:flex-row mb-10 bg-white">
                  <img
